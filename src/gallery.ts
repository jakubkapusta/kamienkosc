...
const PALS: Record<string, Pal> = {
  ...
  kanar: { skin: '#e8b494', acc: '#e8c43a', eye: '#ffd23f', hair: '#2a1a12' },
  poludnica: { skin: '#f2e8dc', acc: '#8a6a2a', eye: '#ffcf3a', hair: '#e8c86a' },
  licho: { skin: '#7a6a8a', acc: '#6a2a8a', eye: '#c86aff', hair: '#3a2a3a' },
  dzik: { skin: '#8a6a52', acc: '#3a6a3a', eye: '#ff6a3a', hair: '#3a2a1e' },
