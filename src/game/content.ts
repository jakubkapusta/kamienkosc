...
export const CLASSES: Record<string, ClassDef> = {
  ...
  plumber: {
    ...
    hp: 70, spells: ['drip', 'chisel'], elem: WATER, traits: { expMana: 3 },
  ...
  trader: {
    ...
    hp: 66, spells: ['change', 'bribe'], elem: AIR, she: true, traits: { coinHit: 1 },
  ...
  dres: {
    ...
    hp: 70, spells: ['rumble', 'stripes'], elem: FIRE, traits: { skull: 1, costAdd: 2 },
